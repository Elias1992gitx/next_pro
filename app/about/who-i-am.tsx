...
function WhoIam() {
  return (
    <div>
      <div className="max-w-5xl py-20 mx-auto px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center relative">
          <div>
            <h1 className="block text-4xl font-semibold text-black sm:text-4xl lg:text-4xl lg:leading-tight tracking-tight">
            ...
            <p className="mt-3 text-lg text-gray-700">
              I'm Elias Chane, a Senior Software Engineer specializing in
              Full-Stack Web Development, with a strong passion for Machine
              Learning and AI.
            </p>
          ...
          <div
            className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-1/4 md:-translate-x-1/2 lg:-translate-x-3/4 w-1/2 md:w-1/3 lg:w-1/4 opacity-50 pointer-events-none"
            aria-hidden="true"
          >
            <svg
          ...
          <div
            className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-1/4 md:translate-x-1/2 lg:translate-x-3/4 w-1/2 md:w-1/3 lg:w-1/4 opacity-50 pointer-events-none"
            aria-hidden="true"
          >
            <svg
              className="w-full h-auto"
          ...
          <div className="relative ms-4">
            ...
            <div className="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6">
              <div className="absolute bottom-0 start-0">
                <div className="absolute bottom-0 start-0">
                  <svg
                    className="w-2/3 ms-auto h-auto text-gray-200"
                    width="630"
                    height="451"
                    viewBox="0 0 630 451"
                    fill="none"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 items-center border divide-y lg:divide-y-0 lg:divide-x divide-neutral-300 rounded-xl">
        <a
        ...
        >
          <div className="mb-5">
            <Rocket size={72} strokeWidth={0.8} className="text-black" />
            <div className="mt-5">
              <h3 className="mt-5 font-medium text-lg text-black">
                Website Development Expertise
              </h3>
              <p className="mt-1 text-gray-600">
                Crafting responsive and dynamic websites using modern frameworks
                with a focus on performance
                and user experience.
              </p>
            </div>
            <p className="mt-auto">
              <span className="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-300 group-hover:border-[#ff0] group-focus:border-[#ff0] transition focus:outline-none">
                Learn more
              </span>
            </p>
          </div>
        ...
        >
          <div className="mb-5">
            <Gem size={72} strokeWidth={0.8} className="text-black" />
            <div className="mt-5">
              <h3 className="mt-5 font-medium text-lg text-black">
                AI and Machine Learning
              </h3>
              <p className="mt-1 text-gray-600">
                Headstarter AI fellow with a passion for implementing
                cutting-edge AI & ML technologies in real-world applications.
              </p>
            </div>
            <p className="mt-auto">
              <span className="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-300 group-hover:border-[#ff0] group-focus:border-[#ff0] transition focus:outline-none">
        ...
        >
          <div className="mb-5">
            <WorkflowIcon size={72} strokeWidth={0.8} className="text-black" />
            <div className="mt-5">
              <h3 className="mt-5 font-medium text-lg text-black">
              ...
              <p className="mt-1 text-gray-600">
                creating
                impactful tech solutions and driving B2B opportunities.
              </p>
            </div>
            <p className="mt-auto">
              <span className="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-300 group-hover:border-[#ff0] group-focus:border-[#ff0] transition focus:outline-none">
